...
<FrameBlock
    ...
    • Shield Target (2P) Generate an energy shield around a target within sensors and line of sight with an HP value equal to your cyber-security stat. This shield cannot be disrupted, but it is deactivated if you break line of sight or the target leaves sensors range.
    • Shield Dome (2P) Generate an energy shield in burst 2 with an HP value equal to 3x your cybersecurity score. This shield cannot be disrupted, but you are immobilized while it is active."
