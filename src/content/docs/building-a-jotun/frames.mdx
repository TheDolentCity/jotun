...
<FrameBlock
    ...
    systems="+1"
    engineering="+3"
    details="Allies in burst 1 of you have resistance to kinetic and explosive damage."
...
<FrameBlock
    ...
    • Your weapon attack range is not limited by sensors.
    • Spend 1 power to activate or deactivate stabilizers. While stabilizers are active, you increase the range of weapons and sensors by +10, you are immobilized, and you are immune to forced movement."
...
<FrameBlock
    ...
    • Spend 1 power to remove the light property from a pilot weapon you use.
...
<FrameBlock
    ...
    systems="+4"
    engineering="+4"
    details="Your frame has an improved version of the shield action along with the shield target and shield dome actions available to you. You can only have one shield active at a time. You can deactivate any shield for 0 power."
    details2="• Shield (1P) Generate an energy shield around yourself with an HP value equal to your cyber-security stat. This shield cannot be disrupted.
    • Shield Target (1P) Generate an energy shield around a target within sensors and line of sight with an HP value equal to your cyber-security stat. This shield cannot be disrupted, but it is deactivated if you break line of sight or the target leaves sensors range.
    • Shield Dome (2P) Generate an energy shield in burst 2 with an HP value equal to 2x your cyber-security stat. This shield cannot be disrupted, but you are immobilized while it is active."
