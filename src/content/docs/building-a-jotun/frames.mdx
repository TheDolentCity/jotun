...
<FrameBlock
    ...
    systems="+2"
    engineering="+0"
    details="As a free action, activate active-camo for the following modifiers:
    ...
    • Deactivate active-camo as an action and vent d6 heat.
...
<FrameBlock
    ...
    • If you moved at least 3 hexes from your starting position on your turn, you can dodge once as a free action before the start of your next turn.
