...
<MountBlock
    ...
    burst="1"
    flame="Special"
    details="Roll 2d4. Decrease heat by that amount and create a heat shield around yourself with an HP value equal to the roll. Any character that starts their turn in burst 1 or moves into burst 1 of you while the shield is active suffers a flame attack equal to the heat shield value. The shield deactivates at the start of your next turn or if you take any other action."
...
<MountBlock
    tags="Minor Melee, Incendiary, Limited 4, Burn 2"
    burst="1"
    flame="1d6"
