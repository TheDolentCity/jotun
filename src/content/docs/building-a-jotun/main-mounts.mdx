...
<MountBlock
    ...
    threat="2"
    attack="1d8"
    details="Increase ARMOR by +3 against melee attacks."
...
<MountBlock
    ...
    range="6"
    attack="1d4"
    details="• Gain shield equal to damage dealt.
...
<MountBlock
    ...
    threat="3"
    attack="1d6"
    details="If the target is knocked into an obstacle heavier than themselves, they must make a chassis check. On a failure, they are knocked prone."
...
<MountBlock
    ...
    attack="1d8"
    heat="1"
    details="Charge 1: required to attack with the weapon. Not required for consecutive attacks. Weapon can be deactivated as a free action."
...
<MountBlock
    tags="Main Rifle, Energy, Charged, Limited 6"
    range="8"
    attack="2d8"
...
<MountBlock
    tags="Main Cannon, Flame, Loading"
    range="6"
    flame="1d4"
    heat="1"
...
<MountBlock
    ...
    • Increase ARMOR by +2 and decrease SPEED by -2 while holding the Tidal Shield.
