...
<MountBlock
    ...
    blast="2"
    attack="NA"
    details="The smoke blocks line of sight and characters in the smoke have concealment. If the smoke takes flame damage, then it ignites and becomes a zone of fire. Any character that starts their turn in the zone or enters a hex in the zone takes 1 flame damage."
