...
<MountBlock
    ...
    threat="1"
    flame="1d4"
    details="On a roll of a 1 the weapon loses power and is disabled until a full repair."
    details2="Spend 1 power to activate the Excalibur Protocol. Spend 0 power to deactivate it. While the protocol is active, the weapon loses the light property."
...
<MountBlock
    ...
    details2="If the spear is thrown and does not deal damage, then it releases a ping in blast 2 of the hex it landed in. Perform the scan action on every hex in that blast. Treat your systems score as +0 for the purposes of these scans."
